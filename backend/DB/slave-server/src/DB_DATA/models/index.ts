...
const TokensSchema = sequelize.define(
   'Tokens',
   {
      userId: {
         type: DataTypes.INTEGER,
...
const BasketSchema = sequelize.define(
   'Basket',
   {
      userId: {
         type: DataTypes.INTEGER,
...
const RatingsSchema = sequelize.define(
   'Ratings',
   {
      ratingId: {
         type: DataTypes.INTEGER,
...
const ProductCommentsSchema = sequelize.define(
   'ProductComments',
   {
      commentId: {
         type: DataTypes.INTEGER,
...
const ProductImagesSchema = sequelize.define(
   'ProductImages',
   {
      itemImagetId: {
         type: DataTypes.INTEGER,
...
const ProductPreviewImageSchema = sequelize.define(
   'ProductPreviewImage',
   {
      productId: {
         type: DataTypes.INTEGER,
...
const ProductDescriptionsSchema = sequelize.define(
   'ProductDescriptions',
   {
      ItemDescriptionId: {
         type: DataTypes.INTEGER,
